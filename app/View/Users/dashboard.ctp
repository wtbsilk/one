        ...
        ?>
            ...
            <div class="col-md-4 active">
                ...
                <div class="info-box  bg-info  text-white" id="initial-tour">
                    ...
                    <div class="info-details">
        <?php
        echo $this->Html->link('<h4>Operation<span class="pull-right"></span></h4>', '/mass_operations', array('data-toggle' => 'tooltip', 'data-placement' => 'right', 'title' => 'Operation', 'escape' => false));
        ?>
                    </div>
                </div>
            </div>
